---
title: "MCP とは？ 〜とりあえずMCPについての概要を抑えたい方へ〜"
emoji: "🤔"
...
Agent 機能が外部の API ドキュメントを MCP サーバー経由で取得し、利用方法を提案したりすることがより精度の高い提案が期待できます。
...
今後もできるだけ新しい技術を追いかけて、業務に活かしていきたい思いです。
